...
export default {
  // Icon
  icon: {
    coin: require('../assets/images/icon-coin.png'),
    bill: require('../assets/images/icon-bill.png'),
    revenue: require('../assets/images/icon-revenue.png'),
    localExpert: require('../assets/images/icon-local-expert.png'),
    city: require('../assets/images/city-icon.png'),
  },
  ...
  zip: require('../assets/images/zip-file.jpg'),
  pdf: require('../assets/images/pdf-icon.png'),
